...
U2OS.Background.SSC_A = U2OS.Background.fcsdat(:,3); 
U2OS.Background.TMR = U2OS.Background.fcsdat(:,5);
[U2OS.CTCF.fcsdat, ~, ~, ~] = fca_readfcs([DataPath, U2OS.CTCF_file]); 
U2OS.CTCF.FSC_A = U2OS.CTCF.fcsdat(:,1); 
U2OS.CTCF.SSC_A = U2OS.CTCF.fcsdat(:,3); 
U2OS.CTCF.TMR = U2OS.CTCF.fcsdat(:,5);

% mESC data: 
[mESC.Background.fcsdat, ~, ~, ~] = fca_readfcs([DataPath, mESC.Background_file]); 
mESC.Background.FSC_A = mESC.Background.fcsdat(:,1); 
mESC.Background.SSC_A = mESC.Background.fcsdat(:,3); 
mESC.Background.TMR = mESC.Background.fcsdat(:,5);
...
for iter = 1:length(mESC.Names)
    ...
    mESC.SSC_A{iter} = mESC.fcsdat{iter}(:,3);
    mESC.TMR{iter} = mESC.fcsdat{iter}(:,5);
end
...
U2OS.Background.SSC_A_gate1 = U2OS.Background.fcsdat_gate1(:,3); 
U2OS.Background.TMR_gate1 = U2OS.Background.fcsdat_gate1(:,5);
...
U2OS.CTCF.SSC_A_gate1 = U2OS.CTCF.fcsdat_gate1(:,3); 
U2OS.CTCF.TMR_gate1 = U2OS.CTCF.fcsdat_gate1(:,5);
...
mESC.Background.SSC_A_gate1 = mESC.Background.fcsdat_gate1(:,3); 
mESC.Background.TMR_gate1 = mESC.Background.fcsdat_gate1(:,5);
% loop over all the mESCs to be quantified:
...
for iter = 1:length(mESC.Names)
    ...
    mESC.SSC_A_gate1{iter} = mESC.fcsdat_gate1{iter}(:,3);
    mESC.TMR_gate1{iter} = mESC.fcsdat_gate1{iter}(:,5);
